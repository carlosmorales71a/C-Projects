...
#include <stdlib.h>
#include "queue.h"
#define Q_SIZE      3   /* define for queue size */
...
void enqueue (QueueInfo element)
{
    ...
    printf("\nEnqueued %s, %.2lf\n",
           customer[rearCustomer].name,
           customer[rearCustomer].bill);
...
void printQueue()
{
    ...
    printf("\nHere is your current shopper's queue:\n");
        ...
        /* dequeue shoppers in queue and store */
        /* them into a temporary queue and then */
