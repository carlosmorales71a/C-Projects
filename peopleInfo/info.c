...
{
        /* update the 'age' and 'money' */
        /* fields of this Info person */
...
Info updateAgain(Info onePerson)
{
    ...
    char name[20];
        ...
        /* copy the field 'firstName' */
        /* of this Info person to */
    ...
    switch (onePerson.age % 2)
    {
        ...
        default: strcat(name, " X ");
            ...
            /* update new info for 'anotherPerson */
            /* by copying 'name ' to the field */
            /* 'firstname' of 'anotherPerson' */
            /* Also update 'age' and 'money' */
            /* fields */
    strcpy(anotherPerson.firstName, name);
    anotherPerson.age = onePerson.age +10;
    anotherPerson.money = onePerson.money + 500.0;

            /* return this newly constructed */
            /* Info person 'anotherPerson' */
